VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptByLocation 
   Bindings        =   "rptByLocation.dsx":0000
   Caption         =   "Reports"
   ClientHeight    =   11010
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   13260
   Icon            =   "rptByLocation.dsx":0018
   MDIChild        =   -1  'True
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E5-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         Object.Width           =   3315
         Object.Height          =   1290
         Picture         =   "rptByLocation.dsx":03A2
      EndProperty
      ItemType1       =   3
   ...
   EndProperty
End
Attribute VB_Name = "rptByLocation"
