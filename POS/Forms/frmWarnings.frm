...
Select Case lvwList.SelectedItem.SubItems(2)
    Case "Expiration"
        frmStocks.ExecSrch "p_code", lvwList.SelectedItem.SubItems(1)
        frmStocks.Show 1
    Case "Expired"
        frmRegister.ViewInventory "p_code", lvwList.SelectedItem.SubItems(1)
        frmRegister.Show 1
    Case "Low Stock"
        frmStocks.ExecSrch "p_code", lvwList.SelectedItem.SubItems(1)
        frmStocks.Show 1
    Case "Low Inventory"
        frmRegister.ViewUnreg "p_code", "%"
        frmRegister.Show 1
    Case "Non-Registered"
        frmRegister.ViewUnreg "p_code", "%"
        frmRegister.Show 1
    Case "Scheduled Task"
        frmScheduler.ExecSrch "tblSchedules", "description", lvwList.SelectedItem.SubItems(1)
        frmScheduler.loadData "tblSchedules", "description", lvwList.SelectedItem.SubItems(1), 3
        frmScheduler.tabScheduler.Tabs(3).Selected = True
        frmScheduler.Show 1
    Case "Delivery Sched"
        frmDelivery.cboSupplier.Text = lvwList.SelectedItem.SubItems(1)
        frmDelivery.Show 1
End Select
