...
Begin VB.Form frmAcntManage 
   ...
   Begin ctrlButton.ThemedButton cmdClear 
      ...
      EndProperty
      MouseIcon       =   "frmAddAccount.frx":038A
      Picture         =   "frmAddAccount.frx":0564
      PictureAlign    =   1
      PictureSize     =   0
   End
   Begin ctrlButton.ThemedButton cmdSave 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      MouseIcon       =   "frmAddAccount.frx":08B8
      Picture         =   "frmAddAccount.frx":0A92
      PictureAlign    =   1
      PictureSize     =   0
   End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboLevel 
         Height          =   315
         ItemData        =   "frmAddAccount.frx":0DE6
         Left            =   1920
         List            =   "frmAddAccount.frx":0DED
   ...
   Begin ctrlButton.ThemedButton cmdOptions 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      MouseIcon       =   "frmAddAccount.frx":0DF9
      PictureAlign    =   1
      PictureSize     =   0
   End
   Begin ctrlButton.ThemedButton cmdEdit 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      MouseIcon       =   "frmAddAccount.frx":0FD3
      Picture         =   "frmAddAccount.frx":11AD
      PictureAlign    =   1
      PictureSize     =   0
   End
   Begin ctrlButton.ThemedButton cmdDelete 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      MouseIcon       =   "frmAddAccount.frx":1501
      Picture         =   "frmAddAccount.frx":16DB
      PictureAlign    =   1
      PictureSize     =   0
   End
   Begin VB.Image imgWarning 
      Height          =   480
      Left            =   120
      MouseIcon       =   "frmAddAccount.frx":1A2F
      MousePointer    =   99  'Custom
      Picture         =   "frmAddAccount.frx":22F9
      Stretch         =   -1  'True
   ...
   Begin VB.Image Image2 
      Height          =   480
      Left            =   0
      Picture         =   "frmAddAccount.frx":2F3D
      Top             =   6360
      Width           =   480
   End
...
RunSql "Select * from tblAccountProfile where id = '" & lstAccounts.SelectedItem & "'"
SecId = Rs.Fields!id
txtId.Text = SecId
RunSql "Select * from tblAccountSecurity where id = '" & lstAccounts.SelectedItem & "'"
With Rs
    If .EOF = True Then
        MsgBox "The security account of this user is not yet set", vbInformation
...
With Rs
    If cmdSave.Caption <> "&Update" Then
        ...
        End If
        .AddNew
        .Fields!record_no = Val(RcrdId("tblAccountSecurity", , "record_no"))
